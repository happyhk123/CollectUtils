 ...
 * Copyright (c) 2019.
 * ************************************************************
 * 文件：JSONUtils.java  模块：app  项目：UseUtils
 * 当前修改时间：2019年09月02日 21:50:09
 * 上次修改时间：2019年09月02日 21:50:09
 * 作者：胡凯
...
public class JSONUtils {
    ...
    public static String getStringCascade(JSONObject jsonObject, String defaultValue, String... keyArray) {
        if (jsonObject == null || CheckisEmptyUtils.isEmpty(keyArray)) {
            return defaultValue;
        }
    ...
    public static Map<String, String> parseKeyAndValueToMap(JSONObject sourceObj) {
        ...
        for (Iterator iter = sourceObj.keys(); iter.hasNext(); ) {
            ...
            if (!CheckisEmptyUtils.isEmpty(keyAndValueMap) && !CheckisEmptyUtils.isEmpty(key)) {
