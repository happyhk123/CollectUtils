 ...
 * Copyright (c) 2019.
 * ************************************************************
 * 文件：IOUtil.java  模块：app  项目：UseUtils
 * 当前修改时间：2019年09月02日 00:12:06
 ...
 * ************************************************************
 */
package com.china.happy.mnk.io;

import android.os.Build;

import com.china.happy.mnk.common.StringUtils;
import com.china.happy.mnk.io.stream.ByteArrayOutputStream;
import com.china.happy.mnk.io.stream.StringBuilderWriter;
...
public class IOUtil {
     ...
     * before using {@link com.china.happy.mnk.io.IOUtil#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see com.china.happy.mnk.io.IOUtil#toByteArray(InputStream, int)
     * @since 2.1
     */
